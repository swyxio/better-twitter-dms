export default function TooMany(props) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
        <div className="text-secondary max-w-prose mx-auto lg:max-w-none">
          ...
          <p className="mt-2 text-3xl text-secondary-2 leading-8 font-extrabold tracking-tight  sm:text-4xl">
            DM bankruptcy is here to help
          </p>
        </div>
        <div className="relative z-10 text-base max-w-prose mx-auto lg:max-w-5xl lg:mx-0 lg:pr-72">
          <p className="text-lg">
            Do you have too many DMs to handle? Have you already declared DM
            bankruptcy and closed down your DMs? Instead of closing your DMs,
            redirect people to your preferred method of communication.
          </p>
        </div>
          ...
          <div className="relative z-10">
            <div className="prose prose-cyan mx-auto lg:max-w-none">
              <h3 className="text-2xl text-secondary-2 leading-8 font-extrabold tracking-tight  sm:text-3xl">
                Create an automated DM bankruptcy message.
              </h3>
              <p className="pt-4">
                Keep the door open for spontaneous connections, but weed out 90%
              ...
              <div className="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
                ...
                <div className="animate-fadeIn relative text-lg flex flex-wrap font-medium mt-8">
                  ...
                  <div className=" flex flex-wrap relative bg-accents-6 p-4 rounded-t-lg text-black font-normal w-3/4 ml-2">
                    <p>
                      I'm not checking my DMs at the moment but I'd love to talk
                      with you. <br />
                      <br /> If you want to get ahold of me, message me at
                      drewb@hey.com. Thanks!
                    </p>
                  </div>
